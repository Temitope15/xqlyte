# XQlyte Data Models Specification

This file serves as the definitive source of truth for all structures used in XQlyte. 

---

## 1. Engine Core Structures
...
These structures represent data models fetched from the logical RPC layer (`FiberRpcClient`).
...
## 3. Persistent Logging Structure
...
pub struct LogEntry {
    ...
    pub result: PaymentConfidenceResult,
